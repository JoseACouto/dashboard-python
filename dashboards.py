...
#tipo de produto mais vendido, contruição por filial
#Desempenho das formas de pagamentos...
#Como estão as avaliações das filiais ?

df = pd.read_csv('supermarket_sales.csv', sep=';', decimal=',') # lendo o arquivo CSV
...
fig_city = px.bar(df_filtered, x='City', y='Total', title='Faturamento por filia')
